...
if __name__=='__main__':
    with EmissionsTracker() as tracker:
        ...
        tracemalloc.start()
        # Load dataset
        dataset = pd.read_csv('GrammarandProductReviews[modified].csv')
       ...
       # Build the CNN+LSTM model
        ...
        x = Embedding(8000, 256, input_length=512)(inputs)
...
# Train the CNN+LSTM model
        history = model.fit(train_data, train_labels, validation_split=0.1, epochs=5, batch_size=64, verbose=0)
