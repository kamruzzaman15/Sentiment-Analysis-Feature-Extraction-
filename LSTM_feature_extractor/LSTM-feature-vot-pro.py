...
if __name__=='__main__':
    with EmissionsTracker() as tracker:
        ...
        x = Embedding(10000, 512, input_length=512)(inputs)
        ...
        voting_clf = VotingClassifier(estimators=[('svm', SVC_clf), ('nb', nb), ('RF',rf )], voting='soft')
        voting_clf.fit(train_features, train_labels)
        preds = voting_clf.predict(test_features)

        acc = accuracy_score(test_labels, preds)
        print("Accuracy For Voting product is: " + str(acc))
