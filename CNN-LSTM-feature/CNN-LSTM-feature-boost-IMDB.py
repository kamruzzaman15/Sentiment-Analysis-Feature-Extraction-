...
if __name__=='__main__':
    with EmissionsTracker() as tracker:
        ...
        full_model.fit(train_data, train_labels, epochs=8, batch_size=64)
        ...
        acc2 = accuracy_score(test_labels, predictions)
        rms2= sqrt(mean_squared_error(test_labels, predictions))


        print("Accuracy For Voting Ensemble is: " + str(acc))
        print("RMSE Error for Voting is: " + str(rms))

        print('Accuracy for Xboost:', acc2)
        print("RMSE Error for Xboost is: " + str(rms2))
