...
if __name__=='__main__':
    with EmissionsTracker() as tracker:
        ...
        train_texts, test_texts, train_labels, test_labels = train_test_split(df['review'], df['positive_review'], test_size=0.2, random_state=42)
        ...
        # Load model
        model = DistilBertForSequenceClassification.from_pretrained('distilbert-base-uncased', num_labels=3, output_hidden_states=True)
        ...
        print('Accuracy for Product with Multi-depth DistilBERT model:', accuracy)
    ...
    print('Co2 for Product with DistilBERT model:', tracker.final_emissions)